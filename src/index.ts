/**
 * ModelTester — Node (host) half.
 *
 * The entire ModelTester surface is a browser feature (a `shell.overlay` panel).
 ...
 * `/plugins/dsh-modeltester/client.js`. It intentionally registers nothing on the
...
/** Cordis plugin name. */
export const name = 'dsh-modeltester'
