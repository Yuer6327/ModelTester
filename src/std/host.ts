 ...
 * lifecycle). The ModelTester surface is a web `shell.overlay` panel; Community
...
const SNAPSHOT: StdFacetProjection = Object.freeze({
  state: 'active',
  message: 'ModelTester panel remains on the native dsh.client web entry; Community v0.15 has no overlay surface',
})
