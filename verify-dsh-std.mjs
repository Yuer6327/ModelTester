/**
 * Static Community v0.15 contract for ModelTester.
 *
...
check('id', manifest.id, 'io.github.yuer6327.modeltester')
check('name', manifest.name, 'ModelTester')
...
check('source.repository', manifest.source?.repository, 'https://github.com/Yuer6327/ModelTester.git')
